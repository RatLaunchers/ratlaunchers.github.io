...
## Power:
Last, but most certainly not least, we have the power system. All of our sensors run off of 3.3V or 5V that will be supplied by their respective controllers. Both the Pi Zero and the Arduino Nano run off of 5V that will be supplied by a buck converter. The buck converter will step the 9V supplied by the 9V battery down to 5V. 
